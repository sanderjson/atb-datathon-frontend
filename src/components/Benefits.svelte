...
<ul class="m-2">
  ...
  {#each benefits as benefit}
    <li class="my-2">
      <svg class="mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path
          ...
          22.536c-4.705 4.667-4.736 12.265-.068 16.971l90.781 91.516c4.667 4.705
          12.265 4.736 16.97.068l172.589-171.204c4.704-4.668
          4.734-12.266.067-16.971z" />
      </svg>
      <span class="text-xl">{benefit}</span>
    </li>
  {/each}
</ul>
